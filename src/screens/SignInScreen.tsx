/**
 * SignInScreen — Returning user login (connected to /auth/login API)
 */
      ...
      >
        ...
        >
          ...
          <View style={styles.headerWrapper}>
            ...
            {/* Cat Noir peeks — GIF on native, webm on web */}
...
const styles = StyleSheet.create({
  ...
  cardTitle: {
    ...
    color: COLORS.DARK_TEXT, marginBottom: 4, letterSpacing: 0.5,
  },
  cardSubtitle: {
    fontFamily: FontFamily.REGULAR, fontSize: 14,
    color: COLORS.MUTED_ON_CARD, marginBottom: 20,
  },
  ...
  primaryButtonText: {
    ...
    color: COLORS.DARK_TEXT, letterSpacing: 0.5,
  },
  arrowCircle: {
